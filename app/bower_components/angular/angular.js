 ...
 *
 * ```js
 * var timetrack = angular.module('timetrack', []);
 * timetrack.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://timetrack.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://timetrack.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * ```
 *  angular.module('timetrack', []).config(function($sceDelegateProvider) {
 ...
 *      'http://timetrack.example.com/clickThru**'
 *    ]);
 *  });
 * ```
 */
 ...
 * <file name="index.html">
 *   <div ng-controller="timetrackController as myCtrl">
 ...
 *
 *   mySceApp.controller("timetrackController", function timetrackController($http, $templateCache, $sce) {
 *     var self = this;
 ...
 *
 * ```
 * angular.module('timetrackWithSceDisabledtimetrack', []).config(function($sceProvider) {
